...
data = load_csv(
    "examples/data/mercury_int10s.csv", x_col="wavelength_nm", y_col="intensity", y_err_col="y_error"
)
...
r_bi = fit(
    ...
    sigma=e_sub,
    p0={"amplitude1": 200, "mean1": 297.4, "sigma1": 1.0, "amplitude2": 400, "mean2": 302.8, "sigma2": 1.2},
)
